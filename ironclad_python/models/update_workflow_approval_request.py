...
class UpdateWorkflowApprovalRequest(BaseModel):
    """
    UpdateWorkflowApprovalRequest
    """ # noqa: E501
    user: UpdateWorkflowApprovalRequestUser
    status: StrictStr = Field(description="The new approval status.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "user": UpdateWorkflowApprovalRequestUser.from_dict(obj["user"]) if obj.get("user") is not None else None,
