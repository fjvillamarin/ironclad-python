...
class CommentMetadataModelRepliedTo(BaseModel):
    """
    CommentMetadataModelRepliedTo
    """ # noqa: E501
    activity_item: Optional[StrictStr] = Field(default=None, alias="activityItem")
    author: Optional[ActivityAuthorModel] = None
    __properties: ClassVar[List[str]] = ["activityItem", "author"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "activityItem": obj.get("activityItem"),
