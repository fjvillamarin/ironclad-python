...
class UpdateWorkflowMetadata200ResponseSchemaLineItemsElementType(BaseModel):
    """
    UpdateWorkflowMetadata200ResponseSchemaLineItemsElementType
    """ # noqa: E501
    type: Optional[StrictStr] = None
    display_name: Optional[StrictStr] = Field(default=None, alias="displayName")
    var_schema: Optional[UpdateWorkflowMetadata200ResponseSchemaLineItemsElementTypeSchema] = Field(default=None, alias="schema")
    __properties: ClassVar[List[str]] = ["type", "displayName", "schema"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "schema": UpdateWorkflowMetadata200ResponseSchemaLineItemsElementTypeSchema.from_dict(obj["schema"]) if obj.get("schema") is not None else None
        })
        return _obj
