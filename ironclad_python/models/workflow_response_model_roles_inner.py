...
class WorkflowResponseModelRolesInner(BaseModel):
    """
    WorkflowResponseModelRolesInner
    """ # noqa: E501
    id: StrictStr
    display_name: StrictStr = Field(alias="displayName")
    assignees: List[WorkflowResponseModelRolesInnerAssigneesInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "assignees": [WorkflowResponseModelRolesInnerAssigneesInner.from_dict(_item) for _item in obj["assignees"]] if obj.get("assignees") is not None else None
        })
        return _obj
