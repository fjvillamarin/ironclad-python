...
class ListAllWebhooks200Response(BaseModel):
    ...
    list: Optional[List[ListAllWebhooks200ResponseListInner]] = None
    __properties: ClassVar[List[str]] = ["page", "pageSize", "list"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "list": [ListAllWebhooks200ResponseListInner.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
