...
class ExternalUserModel(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "displayName", "email", "companyName"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['externalUser']):
            raise ValueError("must be one of enum values ('externalUser')")
        return value
