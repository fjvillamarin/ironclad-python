...
class OutboundEmailResponseEmailOpenedTimestampsInner(BaseModel):
    """
    OutboundEmailResponseEmailOpenedTimestampsInner
    """ # noqa: E501
    email: Optional[StrictStr] = None
    opened: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["email", "opened"]
