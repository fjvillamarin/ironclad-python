...
class ListAllRecords200Response(BaseModel):
    """
    ...
    list: Optional[List[RecordModel]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "list": [RecordModel.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
