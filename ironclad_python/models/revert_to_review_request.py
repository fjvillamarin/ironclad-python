...
class RevertToReviewRequest(BaseModel):
    """
    RevertToReviewRequest
    """ # noqa: E501
    user: RevertToReviewRequestUser
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "user": RevertToReviewRequestUser.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
        return _obj
