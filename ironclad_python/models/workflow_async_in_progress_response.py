...
class WorkflowAsyncInProgressResponse(BaseModel):
    """
    
    """ # noqa: E501
    status: StrictStr
    request_payload: WorkflowRequestModel = Field(alias="requestPayload")
    __properties: ClassVar[List[str]] = ["status", "requestPayload"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "status": obj.get("status") if obj.get("status") is not None else 'in_progress',
