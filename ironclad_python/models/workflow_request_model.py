...
class WorkflowRequestModel(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["template", "creator", "attributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "attributes": AttributesModel.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None
        })
        return _obj
