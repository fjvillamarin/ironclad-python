...
class TurnHistory200Response(BaseModel):
    """
    ...
    list: Optional[List[TurnHistory200ResponseListInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "count": obj.get("count"),
            "list": [TurnHistory200ResponseListInner.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
