...
class InternalUserModel(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "displayName", "email", "userId", "companyName"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['internalUser']):
            raise ValueError("must be one of enum values ('internalUser')")
        return value
