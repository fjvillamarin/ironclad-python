...
class WorkflowStateModelOneOf3(BaseModel):
    """
    WorkflowStateModelOneOf3
    """ # noqa: E501
    state: StrictStr
    message: StrictStr
    ...
    def state_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['not_applicable']):
            raise ValueError("must be one of enum values ('not_applicable')")
        return value
