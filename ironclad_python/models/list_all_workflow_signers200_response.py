...
class ListAllWorkflowSigners200Response(BaseModel):
    """
    ListAllWorkflowSigners200Response
    """ # noqa: E501
    workflow_id: Optional[StrictStr] = Field(default=None, alias="workflowId")
    title: Optional[StrictStr] = None
    signers: Optional[List[ListAllWorkflowSigners200ResponseSignersInner]] = None
    __properties: ClassVar[List[str]] = ["workflowId", "title", "signers"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "title": obj.get("title"),
            "signers": [ListAllWorkflowSigners200ResponseSignersInner.from_dict(_item) for _item in obj["signers"]] if obj.get("signers") is not None else None
        })
        return _obj
