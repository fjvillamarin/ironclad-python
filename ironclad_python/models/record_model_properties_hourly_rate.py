...
class RecordModelPropertiesHourlyRate(BaseModel):
    """
    RecordModelPropertiesHourlyRate
    """ # noqa: E501
    type: Optional[StrictStr] = None
    value: Optional[RecordModelPropertiesHourlyRateValue] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "value": RecordModelPropertiesHourlyRateValue.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
