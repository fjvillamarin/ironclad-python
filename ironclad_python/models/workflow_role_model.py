...
class WorkflowRoleModel(BaseModel):
    """
    
    """ # noqa: E501
    id: Optional[StrictStr] = None
    display_name: Optional[StrictStr] = Field(default=None, alias="displayName")
    assignees: Optional[List[WorkflowRoleAssigneeModel]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "assignees": [WorkflowRoleAssigneeModel.from_dict(_item) for _item in obj["assignees"]] if obj.get("assignees") is not None else None
        })
        return _obj
