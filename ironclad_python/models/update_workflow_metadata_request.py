...
class UpdateWorkflowMetadataRequest(BaseModel):
    ...
    """ # noqa: E501
    updates: List[UpdateWorkflowMetadataRequestUpdatesInner]
    comment: Optional[StrictStr] = Field(default=None, description="A comment that explains the updates you are making to the workflow.")
    __properties: ClassVar[List[str]] = ["updates", "comment"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "updates": [UpdateWorkflowMetadataRequestUpdatesInner.from_dict(_item) for _item in obj["updates"]] if obj.get("updates") is not None else None,
