...
class ListAllWorkflowParticipants200Response(BaseModel):
    """
    ListAllWorkflowParticipants200Response
    """ # noqa: E501
    page: Optional[StrictInt] = 0
    page_size: Optional[StrictInt] = Field(default=20, alias="pageSize")
    count: Optional[StrictInt] = None
    list: Optional[List[ListAllWorkflowParticipants200ResponseListInner]] = None
    __properties: ClassVar[List[str]] = ["page", "pageSize", "count", "list"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pageSize": obj.get("pageSize") if obj.get("pageSize") is not None else 20,
            "count": obj.get("count"),
            "list": [ListAllWorkflowParticipants200ResponseListInner.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
