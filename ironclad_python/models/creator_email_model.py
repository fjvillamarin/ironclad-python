...
class CreatorEmailModel(BaseModel):
    """
    The Ironclad user (must be a user in your Ironclad account) used to launch the workflow by using the user's email address.
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='email', description="The type of value used to identify the user.")
    email: Optional[StrictStr] = Field(default=None, description="The email address of the Ironclad user.")
