...
class ListAllWorkflowApprovals200ResponseRolesInner(BaseModel):
    """
    ListAllWorkflowApprovals200ResponseRolesInner
    """ # noqa: E501
    id: Optional[StrictStr] = None
    display_name: Optional[StrictStr] = Field(default=None, alias="displayName")
    assignees: Optional[List[ListAllWorkflowApprovals200ResponseRolesInnerAssigneesInner]] = None
    __properties: ClassVar[List[str]] = ["id", "displayName", "assignees"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "assignees": [ListAllWorkflowApprovals200ResponseRolesInnerAssigneesInner.from_dict(_item) for _item in obj["assignees"]] if obj.get("assignees") is not None else None
        })
        return _obj
