...
class ListAllRecordsMetadata200ResponseRecordTypes(BaseModel):
    """
    ListAllRecordsMetadata200ResponseRecordTypes
    """ # noqa: E501
    contract: Optional[ListAllRecordsMetadata200ResponseRecordTypesContract] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "contract": ListAllRecordsMetadata200ResponseRecordTypesContract.from_dict(obj["contract"]) if obj.get("contract") is not None else None
        })
        return _obj
