...
class RetrieveEmailThreadsFromWorkflow200Response(BaseModel):
    """
    ...
    list: Optional[List[EmailResponseModel]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "count": obj.get("count"),
            "list": [EmailResponseModel.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
