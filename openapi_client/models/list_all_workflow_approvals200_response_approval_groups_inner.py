...
class ListAllWorkflowApprovals200ResponseApprovalGroupsInner(BaseModel):
    """
    ListAllWorkflowApprovals200ResponseApprovalGroupsInner
    """ # noqa: E501
    reviewers: Optional[List[ListAllWorkflowApprovals200ResponseApprovalGroupsInnerReviewersInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "reviewers": [ListAllWorkflowApprovals200ResponseApprovalGroupsInnerReviewersInner.from_dict(_item) for _item in obj["reviewers"]] if obj.get("reviewers") is not None else None
        })
        return _obj
