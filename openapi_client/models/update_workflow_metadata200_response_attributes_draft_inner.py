...
class UpdateWorkflowMetadata200ResponseAttributesDraftInner(BaseModel):
    """
    UpdateWorkflowMetadata200ResponseAttributesDraftInner
    """ # noqa: E501
    version: Optional[StrictStr] = None
    filename: Optional[StrictStr] = None
    download: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["version", "filename", "download"]
