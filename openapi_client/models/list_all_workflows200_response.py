...
class ListAllWorkflows200Response(BaseModel):
    """
    ListAllWorkflows200Response
    """ # noqa: E501
    page: Optional[StrictInt] = 0
    page_size: Optional[StrictInt] = Field(default=0, alias="pageSize")
    count: Optional[StrictInt] = 0
    list: Optional[List[WorkflowResponseModel]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pageSize": obj.get("pageSize") if obj.get("pageSize") is not None else 0,
            "count": obj.get("count") if obj.get("count") is not None else 0,
            "list": [WorkflowResponseModel.from_dict(_item) for _item in obj["list"]] if obj.get("list") is not None else None
        })
        return _obj
