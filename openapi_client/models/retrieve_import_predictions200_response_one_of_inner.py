...
class RetrieveImportPredictions200ResponseOneOfInner(BaseModel):
    """
    RetrieveImportPredictions200ResponseOneOfInner
    """ # noqa: E501
    record_id: Optional[StrictStr] = Field(default=None, alias="recordId")
    status: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["recordId", "status"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['ready', 'pending', 'errored']):
            raise ValueError("must be one of enum values ('ready', 'pending', 'errored')")
        return value
