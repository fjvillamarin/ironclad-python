...
class CreateAnAttachmentOnARecordRequestMetadata(BaseModel):
    """
    The `metadata` property's value must be `{\"filename\": \"[YOUR_FILE_NAME]\"}`
    """ # noqa: E501
    filename: Optional[StrictStr] = Field(default=None, description="The name of the file. Must have a supported file extension (.adoc, .asice, .bdoc, .csv, .ddoc, .doc, .docx, .edoc, .eml, .gif, .htm, .jpeg, .jpg, .msg, .pdf, .png, .ppt, .pptx, .rtf,.tif, .txt, .xls, .xlsx, .xml).")
