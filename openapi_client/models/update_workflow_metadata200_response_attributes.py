...
class UpdateWorkflowMetadata200ResponseAttributes(BaseModel):
    """
    ...
    draft: Optional[List[UpdateWorkflowMetadata200ResponseAttributesDraftInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "draft": [UpdateWorkflowMetadata200ResponseAttributesDraftInner.from_dict(_item) for _item in obj["draft"]] if obj.get("draft") is not None else None
        })
        return _obj
