...
class ActivityReactionModel(BaseModel):
    """
    ActivityReactionModel
    """ # noqa: E501
    emoji_id: Optional[StrictStr] = Field(default=None, alias="emojiId")
    reactors: Optional[List[UserModel]] = None
    __properties: ClassVar[List[str]] = ["emojiId", "reactors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reactors": [UserModel.from_dict(_item) for _item in obj["reactors"]] if obj.get("reactors") is not None else None
        })
        return _obj
