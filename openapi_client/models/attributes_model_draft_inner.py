...
class AttributesModelDraftInner(BaseModel):
    """
    AttributesModelDraftInner
    """ # noqa: E501
    url: Optional[StrictStr] = Field(default=None, description="URL of the file to be uploaded")
