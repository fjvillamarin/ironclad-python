...
class CreatorIdModel(BaseModel):
    """
    The Ironclad user (must be a user in your Ironclad account) used to launch the workflow by using the user's ID.
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='id', description="The type of value used to identify the user.")
    id: Optional[StrictStr] = Field(default=None, description="The user ID of the Ironclad user.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'id',
            "id": obj.get("id")
        })
        return _obj
