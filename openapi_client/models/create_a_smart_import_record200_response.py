...
class CreateASmartImportRecord200Response(BaseModel):
    """
    CreateASmartImportRecord200Response
    """ # noqa: E501
    record_id: Optional[StrictStr] = Field(default=None, description="Record ID of the new created record", alias="recordId")
    ...
    __properties: ClassVar[List[str]] = ["recordId", "importId", "remainingCredits"]
