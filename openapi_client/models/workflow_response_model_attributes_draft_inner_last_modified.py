...
class WorkflowResponseModelAttributesDraftInnerLastModified(BaseModel):
    """
    WorkflowResponseModelAttributesDraftInnerLastModified
    """ # noqa: E501
    timestamp: Optional[StrictStr] = None
    author: Optional[WorkflowLastModifiedAuthorModel] = None
    __properties: ClassVar[List[str]] = ["timestamp", "author"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "author": WorkflowLastModifiedAuthorModel.from_dict(obj["author"]) if obj.get("author") is not None else None
        })
        return _obj
