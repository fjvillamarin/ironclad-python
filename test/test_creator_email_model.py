...
class TestCreatorEmailModel(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> CreatorEmailModel:
        """Test CreatorEmailModel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreatorEmailModel`
        """
        model = CreatorEmailModel()
        if include_optional:
            return CreatorEmailModel(
                type = 'email',
    ...
    def testCreatorEmailModel(self):
        """Test CreatorEmailModel"""
