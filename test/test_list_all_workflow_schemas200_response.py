...
class TestListAllWorkflowSchemas200Response(unittest.TestCase):
    """ListAllWorkflowSchemas200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListAllWorkflowSchemas200Response:
        """Test ListAllWorkflowSchemas200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListAllWorkflowSchemas200Response`
        """
        model = ListAllWorkflowSchemas200Response()
        if include_optional:
            return ListAllWorkflowSchemas200Response(
                list = [
                    openapi_client.models.list_all_workflow_schemas_200_response_list_inner.list_all_workflow_schemas_200_response_list_inner(
                        id = 'a1b2c3d4', 
                        name = 'MNDA', 
    ...
    def testListAllWorkflowSchemas200Response(self):
        """Test ListAllWorkflowSchemas200Response"""
